...
int main()
{
	...
	add_entry(&my_map, "Number of dolas", 1000000);
	add_entry(&my_map, "lines of code", 420);
	print_map(&my_map);
	printf("\n");
	...
	printf("\n");
	add_entry(&my_map, "a", 1);
	add_entry(&my_map, "b", 1);
	add_entry(&my_map, "c", 1);
	add_entry(&my_map, "d", 1);
	add_entry(&my_map, "e", 1);
	add_entry(&my_map, "f", 1);
	add_entry(&my_map, "g", 1);
	add_entry(&my_map, "h", 1);
	print_map(&my_map);
	printf("\n");
